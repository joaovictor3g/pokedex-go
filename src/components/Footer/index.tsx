      ...
      <Resources>
        ...
        >
          <SimpleLineIcons
            name="home"
            size={26}
            color={currentPage === "home" ? "#fff" : "#6666"}
          />
        ...
        >
          <MaterialCommunityIcons
            name="pokeball"
            size={30}
            color={currentPage === "pokelist" ? "#fff" : "#6666"}
          />
        ...
        >
          <AntDesign
            name="hearto"
            size={30}
            color={currentPage === "favorites" ? "#fff" : "#6666"}
          />
          {currentPage === "favorites" && (
            <ResourceText>Favoritos</ResourceText>
          )}
        </Resource>
        ...
        >
          <Ionicons
            name="person-outline"
            size={30}
            color={currentPage === "profile" ? "#fff" : "#6666"}
          />
